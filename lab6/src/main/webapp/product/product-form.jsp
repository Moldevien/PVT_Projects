...
<html><head><title><%= edit ? "Редагувати" : "Додати" %> товар</title></head><body>
...
<form action="<%= edit ? "update" : "insert" %>" method="post">
    ...
    <label>Назва:</label>
    <input name="name" value="<%= edit ? product.getName() : "" %>" required><br>

    <label>Ціна:</label>
    <input name="price" value="<%= edit ? product.getPrice() : "" %>" required><br>
